...
import ArangoDB from '../public/assets/skills/arangodb.png';
import python from '../public/assets/skills/python.png';
import ClickUp from '../public/assets/skills/clickup.png';
...
const Skills = () => {
  return (
    // lg:h-screen 
    <div id='skills' className='w-full mt-52 mb-64 pt-[6.2rem]'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={ArangoDB} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>ArangoDB</h3>
              </div>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={ClickUp} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>ClickUp</h3>
              </div>
